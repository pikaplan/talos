...
#        TALOS IMPLEMENTATION OF ALEXNET [1]
#
...
#      Neural Networks," in Advances in Neural Information Processing Systems 25, F. Pereira, C. J. C. Burges, 
#      L. Bottou, and K. Q. Weinberger, Eds. Curran Associates, Inc., 2012, pp. 1097�1105.
#
# NOTE: The implementation has 227 x 227
#
# =====================================================================================================================
...
class AlexNet(DCNN):
    ...
    def __init__(self, p_oSettings, p_oExperiment=None):
        #........ |  Instance Attributes | ..............................................
        #................................................................................
        super(AlexNet, self).__init__("AlexNetBase", None, p_oExperiment=p_oExperiment, p_oSettings=p_oSettings)
    #------------------------------------------------------------------------------------        
    def CreateModules(self):
        ...
        ConvMaxPoolLRN(self, 1, oFeatures[1], (11,11), 4, (3,3), 2  , p_bIsLRN=True, p_nActivationType=tcc.NAF_RELU, p_bIsPaddingConv=False)
        ConvMaxPoolLRN(self, 2, oFeatures[2], (5,5)  , 1, (3,3), 2  , p_bIsLRN=True, p_nActivationType=tcc.NAF_RELU)
    ...
    def OldSetupLearning(self):
        ...
        print(self.LearnParams.Momentum)
        self.LearnParams.Momentum=0.8
        ...
        if self.LearnParams.TrainingMethodType == tcc.TRN_ADAM:      
            ...
            if bLegacySetup:
                ...
                #201712_42912
                #self.LearnParams.SetAdaptiveLearningParams(0.80, 0.001, p_nMaxLearningRate=0.06) #Minibatch 15
                self.LearnParams.SetAdaptiveLearningParams(0.90, 0.00001, p_nMaxLearningRate=0.06) #Minibatch 15
